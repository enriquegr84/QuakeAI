...
bool WindowApplication::OnInitialize()
{
	...
	mFileSystem = std::shared_ptr<FileSystem>(new FileSystem());
	...
	*/
	...
	mResCache = std::shared_ptr<ResCache>(new ResCache(200, mountPointFile));
	...
	mEventManager = std::shared_ptr<EventManager>(
...
//----------------------------------------------------------------------------
bool WindowApplication::OnEvent(const Event& evt)
{
	bool result = 0;
