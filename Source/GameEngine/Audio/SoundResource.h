...
/*
	...
	decompresses it if necessary, and manages audio buffers if the same sound
	is being played multiple times.
*/

/*
	SoundResourceExtraData class stores data that will be used by SoundAudio. It is 
