...
public:
	...
	std::string GetMesh(void) { return mMesh; }
	std::string GetShape(void) { return mShape; }
	std::string GetDensity(void) { return mDensity; }
	std::string GetMaterial(void) { return mMaterial; }
	void SetMesh(std::string mesh) { mMesh = mesh; }
	void SetShape(std::string shape) { mShape = shape; }
	void SetDensity(std::string density) { mDensity = density; }
	void SetMaterial(std::string material) { mMaterial = material; }
...
protected:
	...
	std::unordered_set<int> mConvexSurfaces, mIgnoreBSPSurfaces, mIgnorePhysSurfaces;
