...
tinyxml2::XMLElement* TransformComponent::GenerateXml(void)
{
    ...
    pPosition->SetAttribute("x", std::to_string(pos[0]).c_str());
    pPosition->SetAttribute("y", std::to_string(pos[1]).c_str());
    pPosition->SetAttribute("z", std::to_string(pos[2]).c_str());
    ...
    pDirection->SetAttribute("x", std::to_string(yawPitchRoll.mAngle[0]).c_str());
    pDirection->SetAttribute("y", std::to_string(yawPitchRoll.mAngle[1]).c_str());
    pDirection->SetAttribute("z", std::to_string(yawPitchRoll.mAngle[2]).c_str());
	...
	Vector3<float> scale(mTransform.GetScale());
    pPosition->SetAttribute("x", std::to_string(scale[0]).c_str());
    pPosition->SetAttribute("y", std::to_string(scale[1]).c_str());
    pPosition->SetAttribute("z", std::to_string(scale[2]).c_str());
