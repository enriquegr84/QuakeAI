...
inline std::shared_ptr<Texture2> const& SpotLightTextureEffect::GetTexture() const
{
	return mTexture;
}

inline std::shared_ptr<SamplerState> const& SpotLightTextureEffect::GetSampler() const
{
	return mSampler;
}
