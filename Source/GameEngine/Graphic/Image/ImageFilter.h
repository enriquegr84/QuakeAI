...
public:
     ...
     */
    static void ImageCleanTransparent(std::shared_ptr<Texture2> const& src, unsigned int threshold);
     ...
     * and downscaling.
     */
    static void ImageScaleNNAA(std::shared_ptr<Texture2> const& src, 
