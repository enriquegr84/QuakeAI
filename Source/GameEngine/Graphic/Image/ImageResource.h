...
public:
    virtual std::wstring ToString() { return L"ImageResourceExtraData"; }
	virtual std::shared_ptr<Texture2> GetImage() { return mImage; }
	virtual void SetImage(std::shared_ptr<Texture2> img) { mImage = img; }
...
protected:
	...
	std::shared_ptr<Texture2> Load(std::wstring const& filename, bool wantMipmaps);
