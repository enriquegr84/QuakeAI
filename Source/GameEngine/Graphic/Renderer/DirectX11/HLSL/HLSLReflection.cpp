...
void HLSLReflection::SetName(std::string const& name)
{
	mName = name;
}

void HLSLReflection::SetEntry(std::string const& entry)
{
	mEntry = entry;
}

void HLSLReflection::SetTarget(std::string const& target)
{
	mTarget = target;
}

void HLSLReflection::InsertInput(HLSLParameter const& parameter)
{
	mInputs.push_back(parameter);
}

void HLSLReflection::InsertOutput(HLSLParameter const& parameter)
{
	mOutputs.push_back(parameter);
}

void HLSLReflection::Insert(HLSLConstantBuffer const& cbuffer)
{
	mCBuffers.push_back(cbuffer);
}

void HLSLReflection::Insert(HLSLTextureBuffer const& tbuffer)
{
	mTBuffers.push_back(tbuffer);
}

void HLSLReflection::Insert(HLSLStructuredBuffer const& sbuffer)
{
	mSBuffers.push_back(sbuffer);
}

void HLSLReflection::Insert(HLSLByteAddressBuffer const& rbuffer)
{
	mRBuffers.push_back(rbuffer);
}

void HLSLReflection::Insert(HLSLTexture const& texture)
{
	mTextures.push_back(texture);
}

void HLSLReflection::Insert(HLSLTextureArray const& textureArray)
{
	mTextureArrays.push_back(textureArray);
}

void HLSLReflection::Insert(HLSLSamplerState const& samplerState)
{
	mSamplerStates.push_back(samplerState);
}

void HLSLReflection::Insert(HLSLResourceBindInfo const& rbinfo)
{
...
HLSLReflection::Description const& HLSLReflection::GetDescription() const
{
	return mDesc;
}

std::string const& HLSLReflection::GetName() const
{
	return mName;
}

std::string const& HLSLReflection::GetEntry() const
{
	return mEntry;
}

std::string const& HLSLReflection::GetTarget() const
{
	return mTarget;
}
...
std::vector<HLSLParameter> const& HLSLReflection::GetInputs() const
{
	return mInputs;
}

std::vector<HLSLParameter> const& HLSLReflection::GetOutputs() const
{
	return mOutputs;
}

std::vector<HLSLConstantBuffer> const& HLSLReflection::GetCBuffers() const
{
	return mCBuffers;
}

std::vector<HLSLTextureBuffer> const& HLSLReflection::GetTBuffers() const
{
	return mTBuffers;
}

std::vector<HLSLStructuredBuffer> const& HLSLReflection::GetSBuffers() const
{
	return mSBuffers;
}

std::vector<HLSLByteAddressBuffer> const& HLSLReflection::GetRBuffers() const
{
	return mRBuffers;
}

std::vector<HLSLTexture> const& HLSLReflection::GetTextures() const
{
	return mTextures;
}

std::vector<HLSLTextureArray> const& HLSLReflection::GetTextureArrays() const
{
	return mTextureArrays;
}

std::vector<HLSLSamplerState> const& HLSLReflection::GetSamplerStates() const
{
	return mSamplerStates;
}

std::vector<HLSLResourceBindInfo> const& HLSLReflection::GetResourceBindInfos() const
{
	return mRBInfos;
}

std::vector<unsigned char> const& HLSLReflection::GetCompiledCode() const
{
...
unsigned int HLSLReflection::GetNumXThreads() const
{
	return mNumXThreads;
}

unsigned int HLSLReflection::GetNumYThreads() const
{
	return mNumYThreads;
}

unsigned int HLSLReflection::GetNumZThreads() const
{
	return mNumZThreads;
}
