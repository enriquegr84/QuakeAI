...
HLSLShader::HLSLShader(HLSLReflection const& reflector, GraphicObjectType type)
    :
    Shader(type)
{
    ...
    for (auto const& sb : reflector.GetSBuffers())
    {
        ...
        case HLSLStructuredBuffer::Type::SBT_BASIC:
            ctrtype = StructuredBuffer::CounterType::CT_NONE;
            break;

        case HLSLStructuredBuffer::Type::SBT_APPEND:
        case HLSLStructuredBuffer::Type::SBT_CONSUME:
            ctrtype = StructuredBuffer::CounterType::CT_APPEND_CONSUME;
            break;

        case HLSLStructuredBuffer::Type::SBT_COUNTER:
            ctrtype = StructuredBuffer::CounterType::CT_COUNTER;
            break;
