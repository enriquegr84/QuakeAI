...
public:
    ...
    HLSLVisualProgram(const HLSLReflection& vertexShaderHandle, 
        const HLSLReflection& pixelShaderHandle, const HLSLReflection& geometryShaderHandle);

    inline HLSLReflection const& HLSLVisualProgram::GetVertexShaderHandle() const
    {
        return mVertexShaderHandle;
    }

    inline HLSLReflection const& HLSLVisualProgram::GetPixelShaderHandle() const
    {
        return mPixelShaderHandle;
    }

    inline HLSLReflection const& HLSLVisualProgram::GetGeometryShaderHandle() const
    {
        return mGeometryShaderHandle;
    }

private:
    HLSLReflection mVertexShaderHandle, mPixelShaderHandle, mGeometryShaderHandle;
};
