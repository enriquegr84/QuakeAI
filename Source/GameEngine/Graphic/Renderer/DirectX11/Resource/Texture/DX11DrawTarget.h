...
#include "Graphic/Resource/Texture/CustomDrawTarget.h"

#include "DX11TextureDS.h"
#include "DX11TextureRT.h"

class GRAPHIC_ITEM DX11DrawTarget : public CustomDrawTarget
{
public:
    ...
    static std::shared_ptr<CustomDrawTarget> Create(DrawTarget const* target,
		std::vector<CustomGraphicObject*>& rtTextures, CustomGraphicObject* dsTexture);
