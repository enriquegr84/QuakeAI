...
void GLSLReflection::Print(std::ofstream& ostr) const
{
    ...
    for (unsigned int i = 0; i < mUniformBlocks.size(); ++i)
    {
        ...
        ostr << "  {" << std::endl;
        for (unsigned int v = 0; v < block.activeVariables.size(); ++v)
        {
    ...
    for (unsigned int i = 0; i < mAtomicCounterBuffers.size(); ++i)
    {
    ...
    for (unsigned int i = 0; i < mShaderStorageBlocks.size(); ++i)
    {
    ...
    for (unsigned int i = 0; i < mBufferVariables.size(); ++i)
    {
