...
public:
	...
	virtual const std::shared_ptr<VertexBuffer>& GetVertice() const = 0;

	//! Get indices of this meshbuffer
	/** \return Indice of this buffer. */
	virtual const std::shared_ptr<IndexBuffer>& GetIndice() const = 0;
    ...
    //! Recalculate the bounding box. Should be called if the mesh changed.
...
public:
	...
	//! Get vertices of this meshbuffer
	/** \return Vertice of this buffer. */
	virtual const std::shared_ptr<VertexBuffer>& GetVertice() const
	{
		return mVertice;
	}
	...
	//! Get indices of this meshbuffer
	/** \return Indice of this buffer. */
	virtual const std::shared_ptr<IndexBuffer>& GetIndice() const
	{
		return mIndice;
	}
...
protected:
	...
	std::shared_ptr<IndexBuffer> mIndice;

	//! vertices for this meshbuffer.
	std::shared_ptr<VertexBuffer> mVertice;
	...
	std::shared_ptr<IndexBuffer> CreateIBuffer(unsigned int numTriangles, size_t indexSize);
