...
public:
	...
	const std::shared_ptr<VertexBuffer>& GetVertice() const
	{
		switch (mVertexType)
		{
			case VT_TCOORDS:
	...
	const std::shared_ptr<IndexBuffer>& GetIndice() const
	{
		return mIndice;
	}
    ...
    void BoundingBoxNeedsRecalculated(void) { mBoundingBoxNeedsRecalculated = true; }
...
protected:
    ...
    bool mBoundingBoxNeedsRecalculated:1;
	...
	std::shared_ptr<VertexBuffer> mVerticeTangent;
	std::shared_ptr<VertexBuffer> mVerticeTCoords;
