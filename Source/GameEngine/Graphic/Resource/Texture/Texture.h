...
inline unsigned int Texture::GetOffsetFor(unsigned int item, unsigned int level) const
{
    return mLOffset[item][level];
}

inline char const* Texture::GetDataFor(unsigned int item, unsigned int level) const
{
