...
public:
	...
	virtual void SetMesh( const std::shared_ptr<BaseMesh>& mesh );
	...
	virtual const std::shared_ptr<BaseMesh>& GetMesh() const { return mParticleMesh; }
...
private:
	...
	std::shared_ptr<BaseMesh> mParticleMesh;
