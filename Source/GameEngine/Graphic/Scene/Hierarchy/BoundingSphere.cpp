...
bool BoundingSphere::Intersect(Vector4<float> const& origin,
...
bool BoundingSphere::Intersect(BoundingSphere const& sphere) const
{
...
bool BoundingSphere::Intersect(BoundingSphere const& sphere,
