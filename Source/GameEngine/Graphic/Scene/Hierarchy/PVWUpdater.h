...
public:
    ...
    bool Unsubscribe(std::shared_ptr<ConstantBuffer> const& cbuffer);
    void UnsubscribeAll();
...
protected:
	...
	typedef std::multimap<PVWKey, PVWValue>::iterator PVWIterator;
	std::multimap<PVWKey, PVWValue> mSubscribers;
};
