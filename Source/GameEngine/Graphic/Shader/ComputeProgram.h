...
inline std::shared_ptr<Shader> const& ComputeProgram::GetComputeShader() const
{
    return mCShader;
}

inline void ComputeProgram::SetComputeShader(std::shared_ptr<Shader> const& shader)
{
    mCShader = shader;
}
