...
private:
	...
	std::shared_ptr<BaseUIButton> mListButton;
	std::shared_ptr<BaseUIStaticText> mSelectedText;
	std::shared_ptr<BaseUIListBox> mListBox;
	std::shared_ptr<BaseUIElement> mLastFocus;
