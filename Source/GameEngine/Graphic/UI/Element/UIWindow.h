...
public:
	...
	virtual const std::shared_ptr<BaseUIButton>& GetCollapseButton() const = 0;

	//! Returns pointer to the close button
	/** You can hide the button by calling setVisible(false) on the result. */
	virtual const std::shared_ptr<BaseUIButton>& GetCloseButton() const = 0;

	//! Returns pointer to the minimize button
	/** You can hide the button by calling setVisible(false) on the result. */
	virtual const std::shared_ptr<BaseUIButton>& GetMinimizeButton() const = 0;

	//! Returns pointer to the maximize button
	/** You can hide the button by calling setVisible(false) on the result. */
	virtual const std::shared_ptr<BaseUIButton>& GetMaximizeButton() const = 0;
...
public:
	...
	//! Returns pointer to the collapse button
	virtual const std::shared_ptr<BaseUIButton>& GetCollapseButton() const;

	//! Returns pointer to the close button
	virtual const std::shared_ptr<BaseUIButton>& GetCloseButton() const;

	//! Returns pointer to the minimize button
	virtual const std::shared_ptr<BaseUIButton>& GetMinimizeButton() const;

	//! Returns pointer to the maximize button
	virtual const std::shared_ptr<BaseUIButton>& GetMaximizeButton() const;
...
protected:
	...
	std::shared_ptr<Visual> mVisualTitle;
	std::shared_ptr<Visual> mVisualBackground;

	std::shared_ptr<BaseUIScrollBar> mScrollBarV;
	std::shared_ptr<BaseUIButton> mCloseButton;
	std::shared_ptr<BaseUIButton> mMinButton;
	std::shared_ptr<BaseUIButton> mRestoreButton;
	std::shared_ptr<BaseUIButton> mCollapseButton;
