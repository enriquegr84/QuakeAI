...
std::shared_ptr<BaseUIElement> DefaultUIElementFactory::AddUIElement(
	UIElementType type, const std::shared_ptr<BaseUIElement>& parent)
{
	return std::shared_ptr<BaseUIElement>();
}
