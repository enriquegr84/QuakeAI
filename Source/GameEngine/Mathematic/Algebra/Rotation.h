        ...
        && e.mAxis[1] != e.mAxis[2])
    {
        if (e.mAxis[0] != e.mAxis[2])
        {
            ...
            if (rot[e.mAxis[2] * N + e.mAxis[0]] < (Real)1)
            {
                if (rot[e.mAxis[2] * N + e.mAxis[0]] > (Real)-1)
                {
                    ...
                    e.mAngle[0] = atan2(sgn * rot[e.mAxis[2] * N + e.mAxis[1]],
            ...
            if (rot[e.mAxis[0] * N + e.mAxis[2]] < (Real)1)
            {
                if (rot[e.mAxis[0] * N + e.mAxis[2]] > (Real)-1)
                {
                    ...
                    e.mAngle[2] = atan2(sgn * rot[e.mAxis[0] * N + e.mAxis[1]]),
						rot[e.mAxis[0] * N + e.mAxis[0]]);
                    e.mResult = ER_UNIQUE;
                }
                else
        ...
        else
        {
            ...
            if (rot[e.mAxis[2] * N + e.mAxis[2]] < (Real)1)
            {
                if (rot[e.mAxis[2] * N + e.mAxis[2]] > (Real)-1)
                {
                    e.mAngle[2] = atan2(rot[e.mAxis[1] * N + e.mAxis[2]],
                        sgn * rot[b0 * N + e.mAxis[2]]);
                    e.mAngle[1] = acos(rot[e.mAxis[2] * N + e.mAxis[2]]);
                    e.mAngle[0] = atan2(rot[e.mAxis[2] * N + e.mAxis[1]],
                ...
                else
                {
                    ...
                    e.mAngle[0] = atan2(sgn*rot[e.mAxis[1] * N + b0],
						rot[e.mAxis[1] * N + e.mAxis[1]]);
                    e.mResult = ER_NOT_UNIQUE_DIF;
                }
            }
            ...
            if (rot[e.mAxis[0] * N + e.mAxis[0]] < (Real)1)
            {
                if (rot[e.mAxis[0] * N + e.mAxis[0]] > (Real)-1)
                {
                    e.mAngle[0] = atan2(rot[e.mAxis[1] * N e.mAxis[0]],
                        sgn*rot[b2 * N + e.mAxis[0]]);
                    e.mAngle[1] = acos(rot[e.mAxis[0] * N + e.mAxis[0]]);
                    e.mAngle[2] = atan2(rot[e.mAxis[0] * N + e.mAxis[1]],
                ...
                else
                {
                    e.mAngle[0] = (Real)0;
                    e.mAngle[1] = (Real)GE_C_PI;
                    e.mAngle[2] = atan2(sgn*rot[e.mAxis[1] * N + b2],
						rot[e.mAxis[1] * N + e.mAxis[1]]);
                    e.mResult = ER_NOT_UNIQUE_DIF;
                }
            }
