...
class NetSocket 
{
	...
	typedef std::list<std::shared_ptr<BasePacket>> PacketList;
...
public:
	...
	void Send(std::shared_ptr<BasePacket> pkt, bool clearTimeOut=1);
...
public:
	...
	bool Send(int sockId, std::shared_ptr<BasePacket> packet);
