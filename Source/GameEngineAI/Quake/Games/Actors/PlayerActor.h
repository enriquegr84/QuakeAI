...
#define FL_FORCE_GESTURE		0x00008000	// force gesture on visual
...
enum PersistantType
{
	...
	PERS_ATTACKER,					// number of last damage inflicter
...
public:
	...
	void UpdateMovement(const Vector3<float>& velocity, const Vector3<float>& fall);
