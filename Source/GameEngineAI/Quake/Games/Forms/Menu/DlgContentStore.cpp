...
std::string DlgContentStore::GetForm()
{
    std::string form =
        ...
        "image_button[7.3,0;0.8,0.8;art/quake/textures/search.png;search;]"
        "image_button[8.125,0;0.8,0.8;art/quake/textures/clear.png;clear;]"
        ...
        "image_button[0,0;0.8,0.8;art/quake/textures/start_icon.png;pstart;]"
        "image_button[0.8,0;0.8,0.8;art/quake/textures/prev_icon.png;pback;]"
        "style[pagenum;border=false]button[1.6,0;2,0.8;pagenum;1 / 8]"
        "image_button[3.6,0;0.8,0.8;art/quake/textures/next_icon.png;pnext;]"
        "image_button[4.4,0;0.8,0.8;art/quake/textures/end_icon.png;pend;]"
    ...
    form +=
        "container[0.375,1.55]image[0,0;1.5,1;art/quake/cache/cbd/game-siegment-loria.png]"
        ...
        "image_button[-1.55,0;0.7,0.7;art/quake/textures/cdb_clear.png;uninstall_1;]"
        "tooltip[uninstall_1;Uninstall;#dff6f5;#302c2e]]"
        "image_button[-0.7,0;0.7,0.7;art/quake/textures/cdb_viewonline.png;view_1;]"
    ...
    form +=
        "container[0.375,2.925]image[0,0;1.5,1;art/quake/cache/cbd/game-Wuzzy-mineclone2.jpg]"
        ...
        "much more.An imitation of quake.]container_end[]";

    form +=
        "container[0.375,4.3]image[0,0;1.5,1;art/quake/cache/cbd/game-Warr1024-nodecore.jpg]"
        ...
        "image_button[-1.55,0;0.7,0.7;art/quake/textures/cdb_update.png;install_3;]"
        "tooltip[install_3;Update;#dff6f5;#302c2e]]"
        "image_button[-0.7,0;0.7,0.7;art/quake/textures/cdb_viewonline.png;view_1;]"
        "tooltip[view_1;View more information in a web browser;#dff6f5;#302c2e]"
        "container_end[]textarea[1.855,0.3;11.625,0.8;;;"
        "top original voxel game about emergent mechanics and explorationd]container_end[]";

    form +=
        "container[0.375,5.675]image[0,0;1.5,1;art/quake/cache/cbd/game-Wuzzy-tutorial.png]"
    ...
    form +=
        "container[0.375,7.05]image[0,0;1.5,1;art/quake/cache/cbd/game-kay27-mineclone5.png]"
        ...
        "image_button[-1.55,0;0.7,0.7;art/quake/textures/cdb_add.png;install_5;]"
