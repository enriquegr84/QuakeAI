...
std::string Online::GetForm()
{
    ...
    form += "tablecolumns["
        "image,tooltip=Ping,"
        "0=art/quake/textures/blank.png,"
        "1=art/quake/textures/server_ping_4.png,"
        "2=art/quake/textures/server_ping_3.png,"
        "3=art/quake/textures/server_ping_2.png,"
        "4=art/quake/textures/server_ping_1.png,"
        "5=art/quake/textures/server_favorite.png,"
        "6=art/quake/textures/server_public.png,"
        "7=art/quake/textures/server_incompatible.png;"
        "color,span=1;text,align=inline;color,span=1;"
        "text,align=inline,width=4.25;"
        "image,tooltip=Creative mode,"
        "0=art/quake/textures/blank.png,"
        "1=art/quake/textures/server_flags_creative.png,"
        "align=inline,padding=0.25,width=1.5;"
        "image,tooltip=Damage / PvP,"
        "0=art/quake/textures/blank.png,"
        "1=art/quake/textures/server_flags_damage.png,"
        "2=art/quake/textures/server_flags_pvp.png,"
        "align=inline,padding=0.25,width=1.5;"
...
{
    if (name == "btn_mp_refresh")
    {
        const std::shared_ptr<UIForm>& form = std::static_pointer_cast<UIForm>(element->GetParent());
        ...
        std::wstring searchText = searchElement->GetText();

        const std::shared_ptr<BaseUITable>& table =
            std::static_pointer_cast<BaseUITable>(form->GetElementFromId(form->GetField("servers")));
        return true;
    }

    if (name == "btn_mp_clear")
    {
        const std::shared_ptr<UIForm>& form = std::static_pointer_cast<UIForm>(element->GetParent());
        const std::shared_ptr<BaseUIElement>& searchElement =
            std::static_pointer_cast<BaseUIElement>(form->GetElementFromId(form->GetField("te_search")));
