...
{
	std::shared_ptr<HumanView> pHumanView(new AreaLightsHumanView());
	AddView(pHumanView);
...
//----------------------------------------------------------------------------
bool AreaLightsApp::OnEvent(const Event& evt)
{
	bool absorbed = false;
...
void AreaLightsApp::AddView(const std::shared_ptr<BaseGameView>& pView)
{
...
//remove game view
void AreaLightsApp::RemoveView(const std::shared_ptr<BaseGameView>& pView)
{
