...
GameDemoApp::GameDemoApp()
	: GameApplication("GameDemo", 0, 0, 1024, 600, { 0.392f, 0.584f, 0.929f, 1.0f })
{
}
...
//
void GameDemoApp::AddView(const std::shared_ptr<BaseGameView>& pView)
{
...
//
void GameDemoApp::RemoveView(const std::shared_ptr<BaseGameView>& pView)
{
