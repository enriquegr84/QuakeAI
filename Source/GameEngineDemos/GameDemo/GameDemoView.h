...
{
protected:
	std::shared_ptr<MainMenuUI> mMainMenuUI; 
public:
...
protected:
	...
	std::shared_ptr<GameDemoCameraController> mGameCameraController;
	std::shared_ptr<Node> mPlayer;
	std::shared_ptr<StandardHUD> mStandardHUD;
...
public:
	...
	std::shared_ptr<PathingGraph> GetPathingGraph(void) const { return mPathingGraph; }
};
