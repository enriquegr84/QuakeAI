...
#ifndef ABMCOMPONENT_H
#define ABMCOMPONENT_H
...
//---------------------------------------------------------------------------------------------------------------------
// ABM Component implementation class.
//---------------------------------------------------------------------------------------------------------------------
class ABMComponent : public ActorComponent
{
...
public:
    ...
    int RegisterABM(LogicEnvironment* env);
