...
public:
	...
	void Cleanup(const std::shared_ptr<PlayerActor>& player);
...
public:
	...
	void GetAmmoActors(std::vector<std::shared_ptr<Actor>>& ammo);
	void GetArmorActors(std::vector<std::shared_ptr<Actor>>& armor);
	void GetWeaponActors(std::vector<std::shared_ptr<Actor>>& weapon);
	void GetHealthActors(std::vector<std::shared_ptr<Actor>>& health);
	void GetPlayerActors(std::vector<std::shared_ptr<PlayerActor>>& player);
	void GetTriggerActors(std::vector<std::shared_ptr<Actor>>& trigger);
	void GetTargetActors(std::vector<std::shared_ptr<Actor>>& target);

	//Items
	bool CanItemBeGrabbed(const std::shared_ptr<Actor>& item, const std::shared_ptr<PlayerActor>& player);

	//Spawn Points
	void SelectRandomSpawnPoint(std::shared_ptr<Actor>& spot);
...
private:
	...
	void BulletFire(const std::shared_ptr<PlayerActor>& player,
	...
	void ShotgunFire(const std::shared_ptr<PlayerActor>& player,
		const Vector3<float>& muzzle, const Vector3<float>& forward,
		const Vector3<float>& right, const Vector3<float>& up);
	...
	int PickupAmmo(const std::shared_ptr<PlayerActor>& player, 
		const std::shared_ptr<AmmoPickup>& ammo);
	int PickupWeapon(const std::shared_ptr<PlayerActor>& player, 
		const std::shared_ptr<WeaponPickup>& weapon);
	int PickupHealth(const std::shared_ptr<PlayerActor>& player, 
		const std::shared_ptr<HealthPickup>& health);
	int PickupArmor(const std::shared_ptr<PlayerActor>& player, 
		const std::shared_ptr<ArmorPickup>& armor);

	// If true, do not allow multiple players and hide some multiplayer functionality
